...
@Controller
@Scope("request")
@RequestMapping(value = "/HSPSelectPatientEdit") //request mapping usually needed. this will suffice if unless you have multi-page form logic, eg. greater than 2 requests.
public class HSPSelectPatientEdit {
    ...
    public String viewUserHome(Map<String, Object> model) {
        ...
        return "appointment/HSPSelectPatientEdit"; //return the view with linked model
    }
    ...
    public String handlePost(Map<String, Object> model,
       ...
       // System.out.println(ap1.getPatient());//proof.
        return "appointment/HSPSelectPatientEdit"; //this will need to be "redirect:somesuccesspage" at some point.
    }
}
