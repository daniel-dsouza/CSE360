...
<t:template>
    <jsp:body>
        ...
        <form:form action="page1" method="post" commandName="userInput" onsubmit="return checkFormRegistration()"
                ...
                <div class="widget-content" style="padding: 0"> <!-- Border around table and Table -->
                    <table class="table" style="margin-bottom: 0;border: none"> <!-- Rows and cols of the table -->
                        ...
                        <tr> <!-- Row 1 -->
                            ...
                            <td>
                                <form:input class='form-control' size='4' type='text'
                                            path="patientInformation.firstName" id="firstName"
                                            required="true"/> <!-- name can only be letters -->
                            </td>
                            <td>Last Name*:</td>
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.lastName"
                                            id="lastName"
                                            required="true"/> <!-- name can only be letters -->
                            </td>
                        </tr>
                        <tr> <!-- Row 2 -->
                            <td>Age*:</td>
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.age"
                                            id="age"
                        ...
                        <tr> <!-- Row 3 -->
                            <td>City*:</td>
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.city"
                                            required="true"/>
                                <!-- only checked to see if it is empty -->
                            </td>
                            <td>State*:</td>
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.state"
                                            required="true"/>
                                <!-- only checked to see if it is empty -->
                            </td>
                        </tr>
                        <tr> <!-- Row 4 -->
                            <td>Zipcode*:</td>
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.zipcode"
                                            id="zipcode"
                            ...
                            <td>
                                <form:input class='form-control' size='4' type='text'
                                            path="patientInformation.homePhone" id="phone"
                        ...
                        <tr> <!-- Row 5 -->
                            <td>Email*:</td>
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.email"
                                            id="email"
                                            required="true"/>
                            ...
                            <td>
                                <form:input class='form-control' size='4' type='text'
                                            path="patientInformation.insurance"
                                            required="true"/> <!-- only checked to see if it is empty -->
                            </td>
                        </tr>
                        <tr> <!-- Row 6 -->
                            ...
                            <td>
                                <form:input class='form-control' size='4' type='text' path="patientInformation.ssn"
                                            id="ssn"
